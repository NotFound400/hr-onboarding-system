...
| 角色 | 用户名 | 密码 | User ID | Onboarding Status | 用途 |
| :--- | :--- | :--- | :---: | :--- | :--- |
| **HR Admin** | `admin` | `admin1` | 999 | N/A | 测试 HR 仪表盘、审批 |
| **老员工 (已转正)** | `employee` | `123` | 100 | `Approved` | 测试员工主页、个人信息、Visa |
| **新员工 (未填表)** | `new_user` | `123` | 200 | `Pending` | 测试 Onboarding 流程 |
